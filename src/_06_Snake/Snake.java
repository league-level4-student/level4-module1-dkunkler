...
public class Snake {
	...
	public void update() {
		...
		case UP:
			nextLocation.x = head.getLocation().x;
			nextLocation.y = head.getLocation().y-1;
			break;
		case RIGHT:
			nextLocation.x = head.getLocation().x+1;
			nextLocation.y = head.getLocation().y;
			break;
		case DOWN:
			nextLocation.x = head.getLocation().x;
			nextLocation.y = head.getLocation().y+1;
	...
	public boolean isHeadCollidingWithBody() {
		...
		return isLocationOnSnake(head.getLocation());
