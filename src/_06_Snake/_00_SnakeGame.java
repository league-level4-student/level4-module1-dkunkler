...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	private Location foodLocation = new Location(0,0);
	...
	public void startGame() {
		...
		String instructions = "Arrow keys set the snake direction. \nDo not cross the snake with itself.\nCollect food to grow!";
	...
	private void setFoodLocation() {
		...
		Location location = new Location(rand.nextInt(WIDTH), rand.nextInt(HEIGHT));
	...
	private void gameOver() {
		...
		String input = JOptionPane.showInputDialog("Your snake is dead. Do you want to play again?");
